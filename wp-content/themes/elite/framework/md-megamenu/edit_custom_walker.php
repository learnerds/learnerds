...
function md_nav_update($menu_id, $menu_item_db_id, $args ) {
    ...
    if ( isset( $_REQUEST['menu-item-subtitle']) && is_array($_REQUEST['menu-item-subtitle']) ) {
        if(isset($_REQUEST['menu-item-subtitle'][$menu_item_db_id])){
            $subtitle = $_REQUEST['menu-item-subtitle'][$menu_item_db_id];
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <p class="field-target-type description description-wide">
                <label for="edit-menu-item-target-type-<?php echo $item_id; ?>">
                    <?php _e( 'One Page Menu - Target Type' ); ?><br />
            ...
            <p class="field-subtitle description description-wide">
                <label for="edit-menu-item-subtitle-<?php echo $item_id; ?>">
                    <?php _e( 'Subtitle' ); ?><br />
                    <input type="text" id="edit-menu-item-subtitle-<?php echo $item_id; ?>" class="widefat code edit-menu-item-subtitle" name="menu-item-subtitle[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->subtitle ); ?>" />
                </label>
            </p>
