...
$s_bgcolor = ($bgtype == 'bg-custom-color' || $bgtype == 'bg-image') ? 'background-color:'.$bgcolor.';' : '';
...
if($bgmask){
    ...
    $bgmask_hex = hex2rgb($bgmask_color, $bgmask_color_opacity/100);
...
if($fullscreen && $fullscreen_arrow)
$output .= '<a href="#" class="button-hero arrow-down"><i class="icon-angle-down"></i></a>';
$output .= '</div>';
