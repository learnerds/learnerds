...
$md_shortcodes['md_tabs'] = array(
  ...
  "params"          => array(
    array(
      ...
      "shortcode"   => "md_tabs",
      "value"       => "",
      "description" => __('Click on <img src="'.get_template_directory_uri().'/framework/md-page-builder/lib/md-shortcodes/tinymce/shortcode_generator/icons/shortcode-icon.png" /> for add new Tab Element.', "js_composer"),
    ),
    array(
      "type"        => "radio",
