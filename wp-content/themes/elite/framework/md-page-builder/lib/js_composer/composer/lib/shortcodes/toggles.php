...
$md_shortcodes['md_toggles'] = array(
  ...
  "params"          => array(
    array(
      ...
      "value"       => "",
      "description" => __('Click on <img src="'.get_template_directory_uri().'/framework/md-page-builder/lib/md-shortcodes/tinymce/shortcode_generator/icons/shortcode-icon.png" /> for add new Toggle Element.', "js_composer"),
    ),
    array(
      "type"        => "radio",
