...
$icon_margin = ($icon_margin) ? 'margin:'.$icon_margin.';' : false;
...
switch ($icon_style){
    ...
    case 'style-square':
    case 'style-rhombus':
       $style_box = ' style="'.$icon_margin.'border-color:'.$icon_border_color.';"';
    ...
    case 'style-rhombus fill':
        $style_box = ' style="'.$icon_margin.'border-color:'.$icon_border_color.'; background-color:'.$icon_bg_color.';"';
...
$output = '<span'.$class.$id.$css_animation_delay.$style_box.'><i class="'.$icon.'"'.$style.$data_hover.'></i></span>';
