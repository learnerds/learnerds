...
$element_options['icon_color'] = array(
  ...
  "value"       => $md_theme_options['accent-color']
);
...
$element_options['carousel_style'] = array(
  "type"        => "radio",
  "heading"     => __("Carousel Style", "js_composer"),
...
$element_options['button_hero'] =  array(
  "type"        => "radio",
  "heading"     => __("Button hero?", "js_composer"),
  "param_name"  => "hero",
  "value"       => array(
    __("No", "js_composer") => "",
    __("Yes", "js_composer") => "button-hero"
  ),
  "description"   => __("Scroll to next section when click on this button?", "js_composer"),
  'default' => ''
);
