...
vc_map( array(
  ...
  "params"          => array(
    ...
    array(
      ...
      "value"       => array(
        __('No', "js_composer")   => "", 
        __('Yes', "js_composer")   => "fullscreen", 
      ),
      "description" => __("Force fullscreen section (this will overwrite some settings).", "js_composer")
    ),
    array(
      "type"        => "dropdown",
      "heading"     => __("Show Arrow Scroll To?", "js_composer"),
      "param_name"  => "fullscreen_arrow",
      "value"       => array(
        __('No', "js_composer")   => "", 
        __('Yes', "js_composer")   => "yes", 
      ),
      "dependency"  => array('element' => "fullscreen", 'value' => array('fullscreen')),
      "description" => __("Show fullscreen arrow scroll to", "js_composer")
    ),
    array(
      "type"        => "dropdown",
