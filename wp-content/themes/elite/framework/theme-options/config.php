...
if (!class_exists('Redux_Framework_Config')) {
    ...
    class Redux_Framework_Config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'       => 'loading-style',
                        'type'     => 'select',
                        'title'    => __('Page Loading', MD_THEME_NAME), 
                        'subtitle' => __('Set default page loading', MD_THEME_NAME),
                        'options'  => array(
                            'false'  => 'No', 
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'       => 'header-style',
                        'type'     => 'select',
                        'title'    => __('Header Style', MD_THEME_NAME), 
                        'subtitle' => __('Set header style', MD_THEME_NAME),
                        'options'  => array( 'fixed' => 'Fixed Width', 'full-width' => 'Full Width'),
                        'options'  => array(
                            'style-1'  => 'Default', 
                            'style-2'  => 'Alternative Light', 
                            'style-3'  => 'Alternative Light Center', 
                            'style-4'  => 'Alternative Light + Description', 
                            'style-5'  => 'Alternative Light Center + Description', 
                            'style-6'  => 'Alternative Dark', 
                            'style-7'  => 'Alternative Dark Center', 
                            'style-8'  => 'Alternative Dark + Description', 
                            'style-9'  => 'Alternative Dark Center + Description', 
                            'style-10'  => 'Side Navigation', 
                        ),
                        'default'  => 'style-1'
                    ),
                    ...
                    array(
                        ...
                        'type'     => 'radio',
                        'title'    => __('Header Fixed', MD_THEME_NAME), 
                        'subtitle' => __('Set header attachment to fixed or scroll', MD_THEME_NAME),
                        'options'  => array( 'true' => 'Fixed', 'false' => 'Scroll'),
                        'default'  => 'true'
                    ),
                    ...
                    array(
                        ...
                        'options'  => array( 'true' => 'Yes', 'false' => 'No'),
                        'default'  => 'true',
                        'required' => array('header-attachment','=','true')
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'=>'footer_cols',
                        'type' => 'image_select',
                        'title' => __('Footer Columns', MD_THEME_NAME), 
                        'subtitle' => __('Choose number of footer columns', MD_THEME_NAME),
                        'options' => array(
            ...
            $this->sections[] = array(
                'title'     => __('One Page', MD_THEME_NAME),
                'icon'      => 'lineicon-diamons',
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'op-logo-scroll',
                        'type'      => 'media', 
                        'title'     => __('Logo Scroll', MD_THEME_NAME),
                        'subtitle'  => __('Upload your logo while scrolling.', MD_THEME_NAME),
                    ),

                    array(
                        'id'        => 'op-logo-scroll-retina',
                        'type'      => 'media', 
                        'title'     => __('Logo Scroll Retina', MD_THEME_NAME),
                        'subtitle'  => __('Upload your logo while scrolling for retina devices. Make sure that your image ends with symbols @2x (example logo@2x.png)', MD_THEME_NAME),
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'blog-author',
                        'type'      => 'switch', 
                        'title'     => __('Author Box', MD_THEME_NAME),
                        'subtitle'  => __('Enable / disable  Author box.', MD_THEME_NAME),
                        'default'   => 1
                    ),
                    ...
                    array(
                        'id'        => 'blog-social',
                        'type'      => 'switch', 
                        'title'     => __('Social Share Box', MD_THEME_NAME),
                        'subtitle'  => __('Enable / disable Social Share box.', MD_THEME_NAME),
                        'default'   => 1
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                     ...
                     array(
                        'id'       => 'portfolio-share',
                        'type'     => 'switch',
                        'title'    => __('Show portfolio share', MD_THEME_NAME),
                        'subtitle' => __('Enable/disable portfolio share', MD_THEME_NAME),
                        'default'  => 1,
                    ),
                     ...
                     array(
                        ...
                        'subtitle' => __('Enable/disable portfolio pagination', MD_THEME_NAME),
                        'default'  => 1,
                    ),
