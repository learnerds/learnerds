...
$fields = array(
	array(
		...
		'default' => $md_theme_options['page-header-enabled']
	),
	array(
	...
	array(
		...
		'default' => $md_theme_options['page-header-padding']
	),
	array(
	...
	array(
		...
		'type'  => 'colorpicker',
		'default' => $md_theme_options['page-header-title']['color']
	),
	array(
		'name'  => 'page-header-title-animation',
		'label' => __('Page Header Title Animation', MD_THEME_NAME),
		'type'  => 'animations',
		'default' => $md_theme_options['page-header-title-animation']
	),
	array(
	...
	array(
		...
		'type'  => 'animations',
		'default' => $md_theme_options['page-header-subtitle-animation']
	),
	array(
		'name'  => 'page-header-subtitle-color',
		'label' => __('Page Header Subtitle Color', MD_THEME_NAME),
		'type'  => 'colorpicker',
		'default' => $md_theme_options['page-header-subtitle']['color']
	),
	array(
		...
		'default' => $md_theme_options['page-header-align']
	),
	array(
		'name'  => 'page-header-bgcolor',
		'label' => __('Page Header Background Color', MD_THEME_NAME),
		'type'  => 'colorpicker',
		'default' => $md_theme_options['page-header-bgcolor']
	),
	array(
		...
		'default' => $md_theme_options['page-header-bgimage-type']
	),
	array(
	...
	array(
		...
		'default' => $md_theme_options['page-header-bgimage-attach']
	),
	...
	array(
		...
		'default' => $md_theme_options['page-header-mask']
	),
	array(
		'name'  => 'page-header-mask-bgcolor',
		'label' => __('Page Header Mask Background Color', MD_THEME_NAME),
		'type'  => 'colorpicker',
		'default' => $md_theme_options['page-header-mask-bgcolor']
	),
	array(
	...
	array(
		...
		'default' => $md_theme_options['page-header-mask-opacity']
	),
);

$md_metabox['header']['order'] 	= 2;
