...
$fields = array(
	array(
		'name'  => 'post-quote-text',
		'label' => __('Quote Text', MD_THEME_NAME),
		'desc'	=> __('Insert the text of your quote.', MD_THEME_NAME),
		'type'  => 'textarea',
	),
	array(
	...
	array(
		'name'  => 'post-quote-color',
		'label' => __('Quote Color', MD_THEME_NAME),
		'desc'	=> __('Insert the color of your quote.', MD_THEME_NAME),
		'type'  => 'colorpicker',
		'default' => '#ffffff'
	),

	array(
		'name'  => 'post-quote-bgcolor',
		'label' => __('Quote Background Color', MD_THEME_NAME),
		'desc'	=> __('Insert the background color of your quote.', MD_THEME_NAME),
		'type'  => 'colorpicker',
		'default' => $md_theme_options['accent-color']
	),

	array(
		'name'  => 'post-quote-bgimage',
		'label' => __('Quote Background Image', MD_THEME_NAME),
		'desc'	=> __('Insert the background image of your quote.', MD_THEME_NAME),
		'type'  => 'upload',
		'media' => 'image'
	),
...
$fields = array(
	...
	array(
		'name'  => 'post-link-color',
		'label' => __('Link Color', MD_THEME_NAME),
		'desc'	=> __('Insert the color of your link.', MD_THEME_NAME),
		'type'  => 'colorpicker',
		'default' => '#ffffff'
	),

	array(
		'name'  => 'post-link-bgcolor',
		'label' => __('Link Background Color', MD_THEME_NAME),
		'desc'	=> __('Insert the background color of your link.', MD_THEME_NAME),
		'type'  => 'colorpicker',
		'default' => $md_theme_options['accent-color']
	),

	array(
		'name'  => 'post-link-bgimage',
		'label' => __('Link Background Image', MD_THEME_NAME),
		'desc'	=> __('Insert the background image of your link.', MD_THEME_NAME),
		'type'  => 'upload',
		'media' => 'image'
	),
);
...
$fields = array(
	array(
		'name'  => 'post-status-text',
		'label' => __('Status Text', MD_THEME_NAME),
		'desc'	=> __('Insert the text of your quote.', MD_THEME_NAME),
		'type'  => 'textarea',
	),

	array(
		'name'  => 'post-status-color',
		'label' => __('Status Color', MD_THEME_NAME),
		'desc'	=> __('Insert the color of your status.', MD_THEME_NAME),
		'type'  => 'colorpicker',
		'default' => '#ffffff'
	),

	array(
		'name'  => 'post-status-bgcolor',
		'label' => __('Status Background Color', MD_THEME_NAME),
		'desc'	=> __('Insert the background color of your status.', MD_THEME_NAME),
		'type'  => 'colorpicker',
		'default' => $md_theme_options['accent-color']
	),

	array(
		'name'  => 'post-status-bgimage',
		'label' => __('Status Background Image', MD_THEME_NAME),
		'desc'	=> __('Insert the background image of your status.', MD_THEME_NAME),
		'type'  => 'upload',
		'media' => 'image'
	),
...
$md_metabox['post-status']['order'] 	= 5;
$md_metabox['post-status']['id']		= 'meta-post-status';
$md_metabox['post-status']['title'] 	= 'Status Options';
$md_metabox['post-status']['class'] 	= 'md-post-format md-post-status';
$md_metabox['post-status']['icon']  	= 'status-left';
$md_metabox['post-status']['fields'] = $fields;
