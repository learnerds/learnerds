...
if ($page_options['page-header-bgcolor'][0] == $md_theme_options['accent-color']):
...
// Set Class
$class = setClass(array('border-'.$md_theme_options['header-border'], $page_options['page-header-align'][0], $page_header_bg, $page_options['page-header-bgimage-attach'][0], $page_options['page-header-bgimage-type'][0]));
...
$page_header_title_animation = ($page_options['page-header-title-animation'][0]) ? ' class="animate '.$page_options['page-header-title-animation'][0].'"' : '';
$page_header_subtitle_animation = ($page_options['page-header-subtitle-animation'][0]) ? ' class="animate '.$page_options['page-header-subtitle-animation'][0].'"' : '';
?>
